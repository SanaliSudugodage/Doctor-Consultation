...
import { Typography, Box, Paper, Button, Dialog, DialogTitle, DialogContent, DialogActions, CircularProgress, Alert, Avatar } from '@mui/material';
...
const DoctorProfilePage = () => {
    ...
    useEffect(() => {
        const fetchDoctorData = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/doctor/get/${doctor._id}`);
    ...
    const handleDeleteConfirm = () => {
        ...
        axios.delete(`http://localhost:5000/doctor/delete/${doctor._id}`)
            .then((response) => {
    ...
    return (
        <Box sx={{ display: 'flex', height: '100vh', animation: 'fadeIn 1.5s', position: 'relative', overflow: 'hidden' }}>
            ...
            >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'center', marginBottom: '20px', animation: 'bounceIn 1s' }}>
                    <Avatar
                ...
                >
                    <Typography variant="body1" sx={{ marginBottom: '10px', fontSize: '1.2rem' }}>
                ...
                >
                    ...
                    <DialogActions sx={{ justifyContent: 'center' }}>
                        <Button variant="contained" color="primary" onClick={handleDeleteCancel}>
                            Cancel
                        </Button>
