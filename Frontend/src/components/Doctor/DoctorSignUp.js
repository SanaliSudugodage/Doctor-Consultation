...
import { Avatar, Button, CssBaseline, TextField, Grid, Typography, Container, Card, CardContent, makeStyles, Link, Input } from '@material-ui/core';
...
const DoctorSignUp = () => {
    ...
    const validateForm = () => {
        return validateFirstName() && validateLastName() && validateEmail() && validatePassword() && validateRePassword();
    };
