...
import { Drawer, List, ListItem, Button, Typography, Avatar, Divider } from '@mui/material';
  ...
  return (
    ...
    >
      <Avatar
        ...
        sx={{ width: 100, height: 100, marginBottom: '15px', border: '3px solid #ecf0f1' }}
      />
      <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#3c3c3c' }}>
        Dr. {doctor.firstName} {doctor.lastName}
      </Typography>
      <Typography variant="body2" color="textSecondary" sx={{ marginBottom: '10px', color: '#9e9e9e' }}>
        {doctor.specialisation}
      </Typography>
      <Typography variant="body2" color="textSecondary" sx={{ marginBottom: '20px', color: '#9e9e9e' }}>
        {doctor.locations}
      </Typography>
      <Divider sx={{ width: '100%', marginBottom: '20px', borderColor: '#e0e0e0' }} />
      ...
      <List sx={{ width: '100%' }}>
        <ListItem sx={{ padding: 0, marginBottom: '15px' }}>
          <Button
            ...
            sx={{
              ...
              borderRadius: '10px',
              padding: '12px 0',
              boxShadow: selectedItem === 'PatientsPage' ? '0px 4px 10px rgba(0, 0, 0, 0.1)' : 'none',
            }}
          >
            Patients
          </Button>
        ...
        <ListItem sx={{ padding: 0, marginBottom: '15px' }}>
          <Button
            fullWidth
            variant={selectedItem === 'Prescriptions' ? 'contained' : 'outlined'}
            ...
            sx={{
              ...
              borderRadius: '10px',
              padding: '12px 0',
              boxShadow: selectedItem === 'Prescriptions' ? '0px 4px 10px rgba(0, 0, 0, 0.1)' : 'none',
            }}
          >
            Prescriptions
          </Button>
        ...
        <ListItem sx={{ padding: 0, marginBottom: '15px' }}>
          <Button
            fullWidth
            variant={selectedItem === 'DoctorProfilePage' ? 'contained' : 'outlined'}
            ...
            sx={{
              ...
              borderRadius: '10px',
              padding: '12px 0',
              boxShadow: selectedItem === 'DoctorProfilePage' ? '0px 4px 10px rgba(0, 0, 0, 0.1)' : 'none',
            }}
          >
            Account Settings
          </Button>
