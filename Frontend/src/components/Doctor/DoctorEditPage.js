...
import { Avatar, Button, CssBaseline, TextField, Grid, Typography, Container, Card, CardContent, makeStyles, CircularProgress } from '@material-ui/core';
...
const DoctorEditPage = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const updatedDoctor = { firstName, lastName, dob, specialisation, sheduleTimes, locations, email };

        try {
            const response = await axios.put(`http://localhost:5000/doctor/update/${doctor._id}`, updatedDoctor);
            Swal.fire({
                title: "Success!",
