...
const commonData = {
    ...
    medicalHistory: {
      ...
      tinnitus: 'Tinnitus: Occasional ringing in the left ear, described as high-pitched and lasting a few seconds',
      noiseExposure: 'Noise Exposure: History of occupational noise exposure (construction worker for 10 years)',
